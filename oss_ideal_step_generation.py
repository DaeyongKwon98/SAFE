...
from prompts import ideal_reasoning_generation_2wiki, ideal_reasoning_generation_hotpotqa, ideal_reasoning_generation_musique
...
def main(args):
    ...
    if args.dataset == "2wiki":
        ...
        output_path = f"{base_dir}/ideal_steps/2wiki_dev.json"
        system_prompt = ideal_reasoning_generation_2wiki
    elif args.dataset == "hotpotqa":
        plan_path = f"{base_dir}/reasoning_plans/hotpotqa_dev_plan.json"
        data_path = f"{base_dir}/benchmarks/hotpotqa_dev.csv"
        output_path = f"{base_dir}/ideal_steps/hotpotqa_dev.json"
        system_prompt = ideal_reasoning_generation_hotpotqa
    elif args.dataset == "musique":
        plan_path = f"{base_dir}/reasoning_plans/musique_dev_plan.json"
        data_path = f"{base_dir}/benchmarks/musique_dev.csv"
        output_path = f"{base_dir}/ideal_steps/musique_dev.json"
        system_prompt = ideal_reasoning_generation_musique
